...
#define CSR_PWM_CNTRL_ORDEN_ADDR (CSR_BASE + 0x3000L)
...
/* infrarrojo_cntrl */
#define CSR_INFRARROJO_CNTRL_BASE (CSR_BASE + 0x3800L)
#define CSR_INFRARROJO_CNTRL_DISTANCIA_ADDR (CSR_BASE + 0x3800L)
...
/* ultrasonido */
#define CSR_ULTRASONIDO_BASE (CSR_BASE + 0x4000L)
#define CSR_ULTRASONIDO_ORDEN_ADDR (CSR_BASE + 0x4000L)
...
#define CSR_ULTRASONIDO_DONE_ADDR (CSR_BASE + 0x4004L)
...
#define CSR_ULTRASONIDO_D_ADDR (CSR_BASE + 0x4008L)
...
#define CSR_CAMARA_CNTRL_ENABLE_ADDR (CSR_BASE + 0x5800L)
#define CSR_CAMARA_CNTRL_ENABLE_SIZE 1
static inline uint32_t camara_cntrl_enable_read(void) {
	return csr_read_simple(CSR_BASE + 0x5800L);
}
static inline void camara_cntrl_enable_write(uint32_t v) {
...
/* motor */
#define CSR_MOTOR_BASE (CSR_BASE + 0x6800L)
#define CSR_MOTOR_ENTRADA_ADDR (CSR_BASE + 0x6800L)
#define CSR_MOTOR_ENTRADA_SIZE 1
static inline uint32_t motor_entrada_read(void) {
	return csr_read_simple(CSR_BASE + 0x6800L);
}
static inline void motor_entrada_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x6800L);
}

/* mp3 */
#define CSR_MP3_BASE (CSR_BASE + 0x7000L)
#define CSR_MP3_PASAR1_ADDR (CSR_BASE + 0x7000L)
#define CSR_MP3_PASAR1_SIZE 1
static inline uint32_t mp3_pasar1_read(void) {
	return csr_read_simple(CSR_BASE + 0x7000L);
}
static inline void mp3_pasar1_write(uint32_t v) {
