...
HD_PWD='/home/esteban/Escritorio/pProyect_digt_2/MP3/mp3/mp3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP3.tcl
