...
HD_PWD='/home/esteban/Escritorio/pProyect_digt_2/MP3/mp3/mp3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MP3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MP3.tcl -notrace
