...
# [Place 30-574] Poor placement for routing between an IO pin and BUFG. If this sub optimal condition is acceptable for this design, you may use the CLOCK_DEDICATED_ROUTE constraint in the .xdc file to demote this message to a WARNING. However, the use of this override is highly discouraged. These examples can be used directly in the .xdc file to override this clock rule.
 #set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pasar1_IBUF] 

#	pasar1_IBUF_inst (IBUF.O) is locked to IOB_X0Y69
#	 and pasar1_IBUF_BUFG_inst (BUFG.I) is provisionally placed by clockplacer on BUFGCTRL_X0Y0

 
 
## Switches
#Bank = 34, Pin name = IO_L21P_T3_DQS_34,					Sch name = SW0
#set_property PACKAGE_PIN U9 [get_ports {confinit}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {confinit}]
...
#set_property PACKAGE_PIN P4 [get_ports {init}]					
...
#set_property PACKAGE_PIN R2 [get_ports {salida2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {salida2}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {salida1}]					
...
set_property PACKAGE_PIN T16 [get_ports pasar1]						
	set_property IOSTANDARD LVCMOS33 [get_ports pasar1]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
#set_property PACKAGE_PIN R10 [get_ports pasar2]						
#	set_property IOSTANDARD LVCMOS33 [get_ports pasar2]
...
#set_property PACKAGE_PIN H1 [get_ports {salida2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {salida2}]
