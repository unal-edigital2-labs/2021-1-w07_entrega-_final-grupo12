...
class BaseSoC(SoCCore):
	def __init__(self):
		...
		#platform.add_source("module/verilog/camara.v")
                ...
                #PWM
		platform.add_source("module/verilog/Servomotor/BloquePWM.v")
		platform.add_source("module/verilog/Servomotor/PWM.v")
		platform.add_source("module/verilog/Servomotor/MaquinaEstadosPWM.v")
		platform.add_source("module/verilog/Servomotor/DivFreqPWM.v")
