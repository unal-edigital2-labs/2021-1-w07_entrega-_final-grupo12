...
_io = [
  ...
  #  ("led", 11, Pins("T16"), IOStandard("LVCMOS33")),
    ...
    ("vga_hsync", 0, Pins("B11"), IOStandard("LVCMOS33")),
    ("vga_vsync", 0, Pins("B12"), IOStandard("LVCMOS33")),
    

    ("btnu", 0, Pins("M18"), IOStandard("LVCMOS33")),
 
    ("cam_xclk", 0, Pins("F18"), IOStandard("LVCMOS33")),
    ("cam_pclk", 0, Pins("G16"), IOStandard("LVCMOS33")),
    ("clk", 0, Pins("E3"), IOStandard("LVCMOS33")),
    
    ("cam_data_in",  0, Pins("C17"), IOStandard("LVCMOS33")),
    ("cam_data_in",  1, Pins("G18"), IOStandard("LVCMOS33")),
    ("cam_data_in", 2, Pins("D18"), IOStandard("LVCMOS33")),
    ("cam_data_in", 3, Pins("G13"), IOStandard("LVCMOS33")),
    ("cam_data_in", 4, Pins("E17"), IOStandard("LVCMOS33")),
    ("cam_data_in", 5, Pins("F16"), IOStandard("LVCMOS33")),
    ("cam_data_in", 6, Pins("E18"), IOStandard("LVCMOS33")),
    ("cam_data_in", 7, Pins("F13"), IOStandard("LVCMOS33")),
    #("cam_rst", 0, Pins("G17"),IOStandard("LVCMOS33")),
    #("cam_pwdn", 0, Pins("D17"), IOStandard("LVCMOS33")),
    ("cam_href", 0, Pins("D14"), IOStandard("LVCMOS33")),
    ("cam_vsync", 0, Pins("E16"), IOStandard("LVCMOS33")),
    ("salida1", 0 , Pins("F6"),  IOStandard("LVCMOS33")), 
    ("motor_carro", 0 ,Pins("E7"),  IOStandard("LVCMOS33")), 
    ("motor_carro", 1 ,Pins("J3"),  IOStandard("LVCMOS33")), 
    ("motor_carro", 2 ,Pins("K1"),  IOStandard("LVCMOS33")),
    ("motor_carro", 3 ,Pins("H4"),  IOStandard("LVCMOS33")),

     ("ir_inout", 0, Pins("H14"), IOStandard("LVCMOS33")),

    ("pwm", 0, Pins("H16"), IOStandard("LVCMOS33")),

    ("us_trigger", 0, Pins("J2"), IOStandard("LVCMOS33")),
    ("us_echo", 0, Pins("G6"), IOStandard("LVCMOS33")),
...
class Platform(XilinxPlatform):
    ...
    def __init__(self):
        ...
        self.add_platform_command("set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets cam_pclk_IBUF]")
