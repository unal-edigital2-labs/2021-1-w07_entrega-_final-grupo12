...
set_property PACKAGE_PIN V5 [get_ports {orden[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {orden[0]}]
#Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
set_property PACKAGE_PIN U4 [get_ports {orden[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {orden[1]}]
#Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
set_property PACKAGE_PIN V2 [get_ports {orden[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {orden[2]}]
...
##Bank = 15, Pin n= IO_L21P_T3_DQS_15,					Sch name = JA10
