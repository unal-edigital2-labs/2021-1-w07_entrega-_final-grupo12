...
set_property PACKAGE_PIN T8 [get_ports {distancia[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {distancia[0]}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {distancia[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {distancia[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {distancia[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {distancia[2]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
set_property PACKAGE_PIN T6 [get_ports {distancia[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {distancia[3]}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
set_property PACKAGE_PIN T5 [get_ports {distancia[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {distancia[4]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
set_property PACKAGE_PIN T4 [get_ports {distancia[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {distancia[5]}]
#Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
set_property PACKAGE_PIN U7 [get_ports {distancia[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {distancia[6]}]
#Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
set_property PACKAGE_PIN U6 [get_ports {distancia[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {distancia[7]}]
...
set_property PACKAGE_PIN P2 [get_ports {descarga}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {descarga}]
...
set_property PACKAGE_PIN G14 [get_ports {ir_io}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ir_io}]
